...
_Who benefits from this community?_
...
_What does each segment get from us that they can't get elsewhere?_
...
_Who do we need to sustain us, and what kind of relationship do we need with them?_
...
_How do people find us and how do we reach them?_
...
_What do we actually DO? List the top 5–7 ongoing activities._
...
2. Organizing committee sync-up meetings (scheduled a week after monthly meetups)
3. 🚧 Quarterly hands-on training/workshop (planned for the future, currently not started)
4. Curated resources maintenance ([riscvottawa.ca/resources](https://riscvottawa.ca/resources))
5. 🚧 Annual community gathering / unconference (planned for the future, currently not discussed)
6. Online community engagement (Discord Q&A and async help, sharing RISC-V news and project links, lowering the barrier for newcomers between meetups)
7. Partnerships and outreach (guest lectures, representation at university events and conferences, cross-promotion with affiliated foundations)
8. A rolling community open-source project track (a shared, beginner-friendly RISC-V project members can contribute to between events)

## 2.6 Key resources

_What do we need to deliver these activities?_
...
_Distinct from "support". These are operational partners we co-deliver with._
...
**uOttawa, Carleton, Algonquin College**
...
_Rough monthly and annual costs._
...
_How do we measure that we're succeeding at our mission? Not money, but impact._
